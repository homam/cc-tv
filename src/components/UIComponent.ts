...
export class UIComponent {
  ...
  private updateMetricElementWithAnimation(elementId: string, newValue: string): void {
  ...
  private updateTrendIndicators(globalMetrics: any): void {
  ...
  private showRealTimeIndicator(): void {
  ...
  private updateProgressIndicators(globalMetrics: any): void {
  ...
  private animateCount(element: HTMLElement, startValue: number, endValue: number, finalText: string): void {
  ...
  private createStreamingEventsPanel(): void {
  ...
  private updateStreamingEvents(): void {
  ...
  private formatEventMetadata(metadata: any): string {
  ...
  private createAlertsPanel(): void {
  ...
  setFocusView(countryName: string): void {
